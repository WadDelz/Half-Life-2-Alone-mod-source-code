...
//filter stuff
ConVar amod_filter_brightness_on("amod_filter_brightness_on", "0", 0, "Sets the filter's value");
ConVar amod_filter_brightness_on_exp("amod_filter_brightness_on_exp", "0", 0, "Sets the filter's value");
ConVar amod_filter_brightness_off("amod_filter_brightness_off", "0", 0, "Sets the filter's value");
