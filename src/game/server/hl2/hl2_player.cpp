...
public:
	...
	void InputTurnOnFlashlight(inputdata_t &inputdata);
...
BEGIN_DATADESC( CLogicPlayerProxy )
	...
	DEFINE_INPUTFUNC( FIELD_VOID, "EnableFlashlight", InputEnableFlashlight),
	DEFINE_INPUTFUNC( FIELD_VOID, "DisableFlashlight", InputDisableFlashlight),
	DEFINE_INPUTFUNC( FIELD_VOID, "TurnOnFlashlight", InputTurnOnFlashlight),
...
void CLogicPlayerProxy::InputTurnOnFlashlight(inputdata_t& inputdata)
{
	CBasePlayer* pPlayer = UTIL_GetLocalPlayer();
	if (!pPlayer)
		return;
