...
//song functions
extern void Amod_SaveSong(ISave* save);
extern void Amod_LoadSong(IRestore* save);
...
void CServerGameDLL::Save( CSaveRestoreData *s )
{
	...
	//alone mod: call the song save function
	Amod_SaveSong(&saveHelper);
}
...
void CServerGameDLL::Restore( CSaveRestoreData *s, bool b)
{
	...
	//alone mod: call the song restore function
	Amod_LoadSong(&restore);
}
