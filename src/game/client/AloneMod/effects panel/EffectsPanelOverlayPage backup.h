...
{
	Draw_Always,
	Draw_WhenPlayerFlashlightOn,
	Draw_WhenPlayerFlashlightOff,
	Draw_WhenWalking,
	Draw_WhenSprinting,
	Draw_WhenMoving,
	Draw_WhenHealthLow,
	Draw_WhenHealthUnderWater,
};
...
{
	"Always Draw",
	"Only when flashlight on",
	"Only when flashlight off",
	"Only when walking",
	"Only when sprinting",
	"Only when moving at all",
	"Only when health low",
